...
class TestRegistration(BaseTestCase):
    ...
    def test_more_than_3_hood_members(self):
        self.mock_geocode_address.return_value = Point(-75.1764407, 39.9404423, srid=4326)
        self.register_user()
...
class TestAuthentication(BaseTestCase):
    ...
    def test_bad_login(self):
        self.mock_geocode_address.return_value = Point(-75.1764407, 39.9404423, srid=4326)
        self.register_user()
        res = self.post("/api/token/", data={"username": "newuser", "password": "badpassword"})
...
class TestEditUser(BaseTestCase):
    ...
    def test_unauth(self):
        res = self.post("/user/edit/", data={"first_name": "newname", "last_name": "newlast", "description": "newdesc", "address": "334 Amsterdam Ave W 76th St, New York"})
        self.assertEqual(res.status_code, 401)
    ...
    def test_user_edit_success(self):
        ...
        self.register_user()
        self.login_user()
        res = self.post("/user/edit/", data={"username": "backagain","first_name": "newname", "last_name": "newlast", "description": "newdesc", "address": "931 Federal St, Philadelphia"})
        self.assertEqual(res.status_code, 200)
