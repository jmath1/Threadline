...
class TestEditUser(BaseTestCase):
    ...
    def test_unauth(self):
        res = self.post("/api/v1/user/edit/", data={"first_name": "newname", "last_name": "newlast", "address": "334 Amsterdam Ave W 76th St, New York"})
        self.assertEqual(res.status_code, 401)
    ...
    def test_user_edit_success(self):
        ...
        self.login_user(self.user)
        res = self.post("/api/v1/user/edit/", data={"username": "backagain","first_name": "newname", "last_name": "newlast", "address": "931 Federal St, Philadelphia"})
        self.assertEqual(res.status_code, 200)
